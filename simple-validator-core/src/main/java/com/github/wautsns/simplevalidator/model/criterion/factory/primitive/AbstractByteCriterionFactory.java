...
import com.github.wautsns.simplevalidator.model.criterion.kernel.primitive.ByteCriterion;
import com.github.wautsns.simplevalidator.model.node.ConstrainedNode;

import java.lang.annotation.Annotation;

/**
 * Abstract byte criterion factory.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class AbstractByteCriterionFactory<A extends Annotation>
        implements CriterionFactory<A, ByteCriteria, ByteCriterion> {

    @Override
    public final boolean appliesTo(ConstrainedNode node, A constraint) {
        return (byte.class == node.getType());
    }
