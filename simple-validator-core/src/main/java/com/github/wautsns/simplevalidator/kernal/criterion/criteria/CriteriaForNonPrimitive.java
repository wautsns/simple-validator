 ...
 * @since Mar 11, 2020
 */
public class CriteriaForNonPrimitive<T> extends CriterionForNonPrimitive<T>
        implements Criteria<CriterionForNonPrimitive<? super T>> {

    /** Whether the criteria support {@code null} value. */
    private boolean nullable;
    /** Original criteria. */
    private final List<CriterionForNonPrimitive<? super T>> originalCriteria = new LinkedList<>();
    ...
    @Override
    public List<CriterionForNonPrimitive<? super T>> getOriginalCriteria() {
        return originalCriteria;
    }

    @Override
    protected ValidationFailure testWithoutEnhancingFailure(T value) {
        for (CriterionForNonPrimitive<? super T> criterion : originalCriteria) {
