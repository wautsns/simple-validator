 ...
 * @since Mar 11, 2020
 */
public abstract class CriterionForPrimitive<T> extends Criterion {

    /**
     * Test wrapped primitive value.
     *
     * @param value wrapped primitive value
     * @return validation failure, or {@code null} if the validation is passed.
     */
    public abstract ValidationFailure testWrappedPrimitiveValue(T value);
