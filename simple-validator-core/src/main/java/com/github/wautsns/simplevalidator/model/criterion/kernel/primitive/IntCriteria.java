 ...
 * @since Mar 11, 2020
 */
public class IntCriteria extends Criteria<IntCriterion> implements IntCriterion {

    @Override
    public ValidationFailure test(int value) {
        for (IntCriterion criterion : criterionList) {
