...
/**
 * Criterion factory for non-primitive criterion.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class CriterionFactoryForNonPrimitive<A extends Annotation, T>
        extends CriterionFactory<A, CriteriaForNonPrimitive<T>, CriterionForNonPrimitive<? super T>> {}
