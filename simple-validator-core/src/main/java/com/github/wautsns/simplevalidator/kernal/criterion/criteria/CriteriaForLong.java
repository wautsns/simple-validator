 ...
 */
@Getter
public class CriteriaForLong extends CriterionForLong implements Criteria<CriterionForLong> {

    /** Whether the criteria support {@code null} value. */
    private boolean nullable;
    /** Original criteria. */
    private final List<CriterionForLong> originalCriteria = new LinkedList<>();
    ...
    @Override
    public List<CriterionForLong> getOriginalCriteria() {
        return originalCriteria;
    }

    @Override
    protected ValidationFailure testWithoutEnhancingFailure(long value) {
        for (CriterionForLong criterion : originalCriteria) {
