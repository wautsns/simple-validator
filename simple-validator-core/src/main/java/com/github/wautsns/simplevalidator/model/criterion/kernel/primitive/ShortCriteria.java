 ...
 * @since Mar 11, 2020
 */
public class ShortCriteria extends Criteria<ShortCriterion> implements ShortCriterion {

    @Override
    public ValidationFailure test(short value) {
        for (ShortCriterion criterion : criterionList) {
