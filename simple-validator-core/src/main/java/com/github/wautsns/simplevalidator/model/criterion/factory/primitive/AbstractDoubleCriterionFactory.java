 ...
 * @since Mar 11, 2020
 */
public abstract class AbstractDoubleCriterionFactory<A extends Annotation>
        implements CriterionFactory<A, DoubleCriteria, DoubleCriterion> {

    @Override
    public final boolean appliesTo(ConstrainedNode node, A constraint) {
        return (double.class == node.getType());
    }
