...
/**
 * Abstract float criterion factory.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class AbstractFloatCriterionFactory<A extends Annotation>
        implements CriterionFactory<A, FloatCriteria, FloatCriterion> {

    @Override
    public final boolean appliesTo(ConstrainedNode node, A constraint) {
        return (float.class == node.getType());
    }
