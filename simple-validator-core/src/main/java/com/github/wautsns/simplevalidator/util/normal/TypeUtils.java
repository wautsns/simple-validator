...
public class TypeUtils {
    ...
    /**
     * Return {@code true} if the type is assignable to any classes, otherwise {@code false}.
     *
     * @param type type
    ...
    /**
     * Return {@code true} if the type is assignable to all classes, otherwise {@code false}.
     *
     * @param type type
     * @param classes classes
     * @return {@code true} if the type is assignable to all classes, otherwise {@code false}
