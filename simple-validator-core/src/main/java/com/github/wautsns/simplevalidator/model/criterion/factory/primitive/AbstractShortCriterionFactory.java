...
import com.github.wautsns.simplevalidator.model.criterion.kernel.primitive.ShortCriterion;
 ...
 * @since Mar 11, 2020
 */
public abstract class AbstractShortCriterionFactory<A extends Annotation>
        implements CriterionFactory<A, ShortCriteria, ShortCriterion> {

    @Override
    public final boolean appliesTo(ConstrainedNode node, A constraint) {
        return (short.class == node.getType());
    }
