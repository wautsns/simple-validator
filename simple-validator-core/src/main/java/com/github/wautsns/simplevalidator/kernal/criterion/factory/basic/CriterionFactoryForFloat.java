...
/**
 * Criterion factory for {@code float} type.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class CriterionFactoryForFloat<A extends Annotation>
        extends CriterionFactory<A, CriteriaForFloat, CriterionForFloat> {
