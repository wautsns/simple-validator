 ...
 * @since Mar 11, 2020
 */
public abstract class CriterionForNonPrimitive<T> extends Criterion {

    /** Truth. */
    public static final CriterionForNonPrimitive<Object> TRUTH = new CriterionForNonPrimitive<Object>() {
        @Override
     ...
     *
     * @param value non-primitive value
     * @return validation failure, or {@code null} if the validation is passed.
     */
    public final ValidationFailure test(T value) {
    ...
    /**
     * Test non-primitive value without enhancing failure.
     *
     * @param value non-primitive value
     * @return validation failure without enhancing failure, or {@code null} if the validation is passed.
     */
    protected abstract ValidationFailure testWithoutEnhancingFailure(T value);
