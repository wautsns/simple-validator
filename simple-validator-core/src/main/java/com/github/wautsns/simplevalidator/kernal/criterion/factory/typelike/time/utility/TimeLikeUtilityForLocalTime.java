...
/**
 * Time-like utility for {@code LocalTime} value.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public class TimeLikeUtilityForLocalTime extends TimeLikeUtility<LocalTime> {

    /** Default {@code TimeLikeUtilityForLocalTime}. */
    public static final TimeLikeUtilityForLocalTime DEFAULT = new TimeLikeUtilityForLocalTime(null);

    /**
     * Construct a time-like utility for {@code LocalTime} value.
     *
     * @param formatter value formatter
     */
    public TimeLikeUtilityForLocalTime(Formatter<LocalTime> formatter) {
        super(formatter);
    }
