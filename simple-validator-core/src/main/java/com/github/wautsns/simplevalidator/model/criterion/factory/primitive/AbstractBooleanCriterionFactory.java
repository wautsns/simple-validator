...
import com.github.wautsns.simplevalidator.model.criterion.kernel.primitive.BooleanCriterion;
import com.github.wautsns.simplevalidator.model.node.ConstrainedNode;

import java.lang.annotation.Annotation;

/**
 * Abstract boolean criterion factory.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class AbstractBooleanCriterionFactory<A extends Annotation>
        implements CriterionFactory<A, BooleanCriteria, BooleanCriterion> {

    @Override
    public final boolean appliesTo(ConstrainedNode node, A constraint) {
        return (boolean.class == node.getType());
    }
