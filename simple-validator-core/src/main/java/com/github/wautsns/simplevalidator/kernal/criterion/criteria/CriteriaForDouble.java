...
/**
 * Criteria for {@code double} value.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public class CriteriaForDouble extends CriterionForDouble implements Criteria<CriterionForDouble> {

    /** Whether the criteria support {@code null} value. */
    private boolean nullable;
    /** Original criteria. */
    private final List<CriterionForDouble> originalCriteria = new LinkedList<>();
    ...
    @Override
    public List<CriterionForDouble> getOriginalCriteria() {
        return originalCriteria;
    }

    @Override
    protected ValidationFailure testWithoutEnhancingFailure(double value) {
        for (CriterionForDouble criterion : originalCriteria) {
