...
/**
 * Time-like utility for {@code LocalDate} value.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public class TimeLikeUtilityForLocalDate extends TimeLikeUtility<LocalDate> {

    /** Default {@code TimeLikeUtilityForLocalDate}. */
    public static final TimeLikeUtilityForLocalDate DEFAULT = new TimeLikeUtilityForLocalDate(null);

    /**
     * Construct a time-like utility for {@code LocalDate} value.
     *
     * @param formatter value formatter
     */
    public TimeLikeUtilityForLocalDate(Formatter<LocalDate> formatter) {
        super(formatter);
    }
