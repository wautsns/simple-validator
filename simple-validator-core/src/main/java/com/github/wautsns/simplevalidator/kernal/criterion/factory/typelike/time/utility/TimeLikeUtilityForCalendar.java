...
/**
 * Time-like utility for {@code Calendar} value.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public class TimeLikeUtilityForCalendar extends TimeLikeUtility<Calendar> {

    /** Default {@code TimeLikeUtilityForCalendar}. */
    public static final TimeLikeUtilityForCalendar DEFAULT = new TimeLikeUtilityForCalendar(null);

    /**
     * Construct a time-like utility for {@code Calendar} value
     *
     * @param formatter value formatter
     */
    public TimeLikeUtilityForCalendar(Formatter<Calendar> formatter) {
        super(formatter);
    }
