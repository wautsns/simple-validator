...
/**
 * Criterion factory for {@code byte} type.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class CriterionFactoryForByte<A extends Annotation>
        extends CriterionFactory<A, CriteriaForByte, CriterionForByte> {
