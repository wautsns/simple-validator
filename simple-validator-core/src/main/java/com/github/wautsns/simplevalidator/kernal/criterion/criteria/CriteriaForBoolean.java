...
/**
 * Criteria for {@code boolean} value.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public class CriteriaForBoolean extends CriterionForBoolean implements Criteria<CriterionForBoolean> {

    /** Whether the criteria support {@code null} value. */
    private boolean nullable;
    /** Original criteria. */
    private final List<CriterionForBoolean> originalCriteria = new LinkedList<>();
    ...
    @Override
    public List<CriterionForBoolean> getOriginalCriteria() {
        return originalCriteria;
    }

    @Override
    protected ValidationFailure testWithoutEnhancingFailure(boolean value) {
        for (CriterionForBoolean criterion : originalCriteria) {
