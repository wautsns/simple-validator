 ...
 * @since Mar 11, 2020
 */
public abstract class CriterionFactoryForComparableNumber<A extends Annotation>
        extends CriterionFactoryForComparable<A, Number> {

    @Override
    public boolean applyTo(Type type, A constraint) {
        return TypeUtils.isAssignableTo(type, Number.class)
                && super.applyTo(type, constraint);
    }
