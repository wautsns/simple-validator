...
/**
 * Criterion factory for {@code char} type.
 *
 * @author wautsns
 * @since Mar 11, 2020
 */
public abstract class CriterionFactoryForChar<A extends Annotation>
        extends CriterionFactory<A, CriteriaForChar, CriterionForChar> {
