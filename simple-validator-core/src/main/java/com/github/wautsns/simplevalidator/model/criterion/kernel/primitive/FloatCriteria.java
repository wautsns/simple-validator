 ...
 * @since Mar 11, 2020
 */
public class FloatCriteria extends Criteria<FloatCriterion> implements FloatCriterion {

    @Override
    public ValidationFailure test(float value) {
        for (FloatCriterion criterion : criterionList) {
